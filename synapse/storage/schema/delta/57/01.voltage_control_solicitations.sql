...
CREATE TABLE voltage_control_solicitation ( id INTEGER PRIMARY KEY, solicitation_group_id INTEGER, action_code TEXT, equipment_code TEXT, substation_code TEXT, staggered BOOLEAN, amount TEXT, voltage TEXT, FOREIGN KEY(substation_code) REFERENCES substation(code), FOREIGN KEY(solicitation_group_id) REFERENCES solicitation_group(id));
