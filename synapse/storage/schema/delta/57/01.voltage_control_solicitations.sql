...
CREATE TABLE voltage_control_solicitation ( id INTEGER PRIMARY KEY, action_code TEXT, equipment_code TEXT, substation_code TEXT, staggered BOOLEAN, amount TEXT, voltage TEXT, request_user_id TEXT, creation_timestamp INTEGER, response_user_id TEXT, status TEXT, update_timestamp INTEGER, FOREIGN KEY(substation_code) REFERENCES substation(code));
